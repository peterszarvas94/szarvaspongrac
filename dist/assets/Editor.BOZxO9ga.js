...
import { pb, getURLFromRecord } from './db.C5qaP7U7.js';
import { getCachedContent } from './content-manager.CYLXbdb_.js';
import { getEditMode, EditModeEvent, showAlert } from './ProseLayout.astro_astro_type_script_index_0_lang.DScCh2na.js';
...
var Bold$1 = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$g,
  name: "bold"
}));
var bold_default = Bold$1;
...
var Italic$1 = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$b,
  name: "italic"
}));
var italic_default = Italic$1;
...
const extensions = [index_default$2, index_default$1.configure({
