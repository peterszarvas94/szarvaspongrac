...
import { getCachedContent, pb, getURLFromRecord } from './db.DZiNoy5o.js';
import { getEditMode, EditModeEvent, showAlert } from './ProseLayout.astro_astro_type_script_index_0_lang.DzFQzbr_.js';
...
var StarterKit = Extension.create({
  ...
  addExtensions() {
    ...
    if (this.options.bold !== false) {
      extensions.push(Bold$1.configure(this.options.bold));
    }
    ...
    if (this.options.italic !== false) {
      extensions.push(Italic$1.configure(this.options.italic));
    }
    if (this.options.listItem !== false) {
      extensions.push(ListItem.configure(this.options.listItem));
    }
...
var _tmpl$$1 = /* @__PURE__ */ template(`<svg>`);
...
var Bold = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$g,
  name: "bold"
}));
...
var Heading1 = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$f,
  name: "heading-1"
}));
...
var Heading2 = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$e,
  name: "heading-2"
}));
...
var Heading3 = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$d,
  name: "heading-3"
}));
...
var Italic = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$b,
  name: "italic"
}));
...
var ListOrdered = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$a,
  name: "list-ordered"
}));
...
var Pilcrow = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$8,
  name: "pilcrow"
}));
...
var Quote = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$7,
  name: "quote"
}));
...
var Redo = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$6,
  name: "redo"
}));
...
var Strikethrough = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$5,
  name: "strikethrough"
}));
...
var TextAlignCenter = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$4,
...
var TextAlignEnd = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$3,
  name: "text-align-end"
}));
...
var TextAlignJustify = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$2,
...
var TextAlignStart = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode: iconNode$1,
...
var Undo = (props) => createComponent(Icon_default, mergeProps(props, {
  iconNode,
  name: "undo"
}));
...
const extensions = [index_default, index_default$2.configure({
...
const toolbarActions = [{
  ...
  title: "Címsor 1",
  run: (e) => e.chain().focus().toggleHeading({
    level: 1
  }).run(),
...
function Editor(props) {
  ...
  onMount(() => {
    window.addEventListener(EditModeEvent.eventName, handleEditModeChange);
    onCleanup(() => {
      window.removeEventListener(EditModeEvent.eventName, handleEditModeChange);
    });
  });
  return createComponent(Show, {
    get when() {
      return memo(() => !!isEditMode())() && content();
    },
    get children() {
    ...
    insert(_el$2, createComponent(For, {
      ...
      children: (item) => {
        ...
        return (() => {
          ...
          className(_el$7, `tiptap-button ${isActive ? "tiptap-button-selected" : ""}`);
          insert(_el$7, () => item.icon());
          createRenderEffect(() => setAttribute(_el$7, "title", item.title));
          runHydrationEvents();
          return _el$7;
        })();
      }
