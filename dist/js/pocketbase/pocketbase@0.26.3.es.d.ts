 ...
 * ```
 */
declare function cookieSerialize(
  name: string,
  val: string,
...
declare function serializeQueryParams(params: { [key: string]: any }): string;
 ...
 */
declare function isTokenExpired(
  token: string,
