...
func (h *Handler) Upload(c echo.Context) error {
	...
	adminHTML, err := utils.RenderHTMLForRequest(c, pages.HomeAdmin(view.HomeAdminData{
		ContentKey:   key,
		Authed:       true,
		EditMode:     pageState.EditMode,
		HeroURL:      img.URL,
		HeroFilename: img.Filename,
	}))
	if err != nil {
		return err
	}
	if err := utils.SSEHub.PatchHTML(c, adminHTML, datastar.WithSelector("#home-admin"), datastar.WithMode(datastar.ElementPatchModeOuter)); err != nil {
		return err
	}
